...
//            }
    ...
    private boolean handleUsers(CommandSender sender, String args[])
    {
    ...
    private boolean handleUserCommands(CommandSender sender, String args[])
    {
        if (args.length < 3)
        {
...
//user commands
    private boolean handleUserCommandsList(CommandSender sender, String args[])
    {
    ...
    private boolean handleUserCommandsGroups(CommandSender sender, String args[])
    {
    ...
    private boolean handleUserCommandsInfo(CommandSender sender, String args[])
    {
    ...
    private boolean handleUserCommandsDelete(CommandSender sender, String args[])
    {
    ...
    private boolean handleUserCommandsPermAdd(CommandSender sender, String args[])
    {
    ...
    private boolean handleUserCommandsPermRemove(CommandSender sender, String args[])
    {
    ...
    private boolean handleUserCommandsHas(CommandSender sender, String args[])
    {
        ...
        else
        {
            if (world == null)
            {
                boolean has = pm.hasPermOnServer(user.getName(), args[3].toLowerCase(), server);
            ...
            {
                boolean has = pm.hasPermOnServerInWorld(user.getName(), args[3].toLowerCase(), server, world);
    ...
    private boolean handleUserCommandsGroupAdd(CommandSender sender, String args[])
    {
    ...
    private boolean handleUserCommandsGroupRemove(CommandSender sender, String args[])
    {
    ...
    private boolean handleUserCommandsGroupSet(CommandSender sender, String args[])
    {
...
//end user commands
    ...
    private boolean handleGroupCommands(CommandSender sender, String args[])
    {
        if (args.length < 3)
        {
            Messages.sendTooLessArgsMessage(sender);
...
//group commands
    private boolean handleGroupCommandsList(CommandSender sender, String args[])
    {
    ...
    private boolean handleGroupCommandsInfo(CommandSender sender, String args[])
    {
    ...
    private boolean handleGroupCommandsUsers(CommandSender sender, String args[])
    {
    ...
    private boolean handleGroupCommandsCreate(CommandSender sender, String args[])
    {
    ...
    private boolean handleGroupCommandsDelete(CommandSender sender, String args[])
    {
    ...
    private boolean handleGroupCommandsPermAdd(CommandSender sender, String args[])
    {
    ...
    private boolean handleGroupCommandsPermRemove(CommandSender sender, String args[])
    {
    ...
    private boolean handleGroupCommandsHas(CommandSender sender, String args[])
    {
    ...
    private boolean handleGroupCommandsInheritAdd(CommandSender sender, String args[])
    {
    ...
    private boolean handleGroupCommandsInheritRemove(CommandSender sender, String args[])
    {
    ...
    private boolean handleGroupCommandsRank(CommandSender sender, String args[])
    {
    ...
    private boolean handleGroupCommandsWeight(CommandSender sender, String args[])
    {
    ...
    private boolean handleGroupCommandsLadder(CommandSender sender, String args[])
    {
    ...
    private boolean handleGroupCommandsDefault(CommandSender sender, String args[])
    {
    ...
    private boolean handleGroupCommandsDisplay(CommandSender sender, String args[])
    {
    ...
    private boolean handleGroupCommandsPrefix(CommandSender sender, String args[])
    {
    ...
    private boolean handleGroupCommandsSuffix(CommandSender sender, String args[])
    {
...
//end group commands
    ...
    private boolean handleFormat(CommandSender sender, String args[])
    {
    ...
    private boolean handleMigrateBackend(CommandSender sender, String args[])
    {
        if (args.length == 2)
        {
            sender.sendMessage(Color.Text + "Currently using " + Color.Value + pm.getBackEnd().getType().name() + Color.Text + " as backend");
...
//                        + Color.Value + BackEndType.MySQL.name() + Color.Error + " or "
    ...
    private boolean handleMigrateUseUUID(CommandSender sender, String args[])
    {
        if (args.length == 2)
        {
            sender.sendMessage(Color.Text + "Currently using " + Color.Value + (pm.isUseUUIDs() ? "UUIDs" : "player names") + Color.Text + " for player identification");
        }
        else if (args.length == 3)
        {
            String stype = args[2];
    ...
    private boolean handleMigrateUUIDPlayerDB(CommandSender sender, String args[])
    {
        if (args.length == 2)
        {
    ...
    private boolean handleUUID(CommandSender sender, String args[])
    {
    ...
    private void showHelp(CommandSender sender)
    {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.user.info"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.user.perms.remove"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.user.perms.has"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.user.perms.list"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.user.group.add"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.user.group.remove"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.user.group.set"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.user.groups"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.groups"))
        {
            sender.sendMessage(ChatColor.GOLD + "/bungeeperms groups" + ChatColor.WHITE + " - " + ChatColor.GRAY + "Lists the groups");
        }
        if (pm.hasPermOrConsole(sender, "bungeeperms.group.info"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.group.users"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.group.create"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.group.delete"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.group.inheritances.add"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.group.inheritances.remove"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.group.rank"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.group.weight"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.group.ladder"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.group.default"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.group.display"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.group.prefix"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.group.suffix"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.group.perms.add"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.group.perms.remove"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.group.perms.has"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.group.perms.list"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.promote"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.demote"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.format"))
        {
        ...
        if (pm.hasPermOrConsole(sender, "bungeeperms.cleanup"))
        {
