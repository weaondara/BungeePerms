...
public class Lang
{
    ...
    public static enum MessageType
    {
        ...
        USER_PERMISSIONS("user.permissions-count", Color.Text.alt() + "User permissions: " + Color.Value.alt() + "{0}"),
        USER_ALL_PERMISSIONS_COUNT("user.permissions-count", Color.Text.alt() + "All permissions: " + Color.Value.alt() + "{0}"),
