...
public class HelpProvider
{
    ...
    static
    {
        ...
        HELP_ENTRIES.add(new HelpEntry("bungeeperms.user.group.add",/*           */ makeSuggestCommand("/bp user <user> addtimedgroup <group> <duration>", Lang.translate(MessageType.HELP_USER_ADDTIMEDGROUP))));
        ...
        HELP_ENTRIES.add(new HelpEntry("bungeeperms.user.group.remove",/*        */ makeSuggestCommand("/bp user <user> removetimedgroup <group>", Lang.translate(MessageType.HELP_USER_REMOVETIMEDGROUP))));
        ...
        HELP_ENTRIES.add(new HelpEntry("bungeeperms.group.inheritances.add",/*   */ makeSuggestCommand("/bp group <group> addtimedinherit <addgroup> <duration>", Lang.translate(MessageType.HELP_GROUP_ADDTIMEDINHERIT))));
        ...
        HELP_ENTRIES.add(new HelpEntry("bungeeperms.group.inheritances.remove",/**/ makeSuggestCommand("/bp group <group> removetimedinherit <removegroup>", Lang.translate(MessageType.HELP_GROUP_REMOVETIMEDINHERIT))));
